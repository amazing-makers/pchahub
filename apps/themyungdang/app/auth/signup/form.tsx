...
const ROLES: Array<{ key: Role; label: string; helper: string; icon: typeof Search }> = [
  { key: 'buyer', label: '매물 찾는 분', helper: '임대·양도 탐색', icon: Search },
  { key: 'seller', label: '매물 올리는 분', helper: '권리금 양도·임대 등록', icon: Store },
  { key: 'agent', label: '부동산·공인중개사', helper: '매물 관리·중개 서비스', icon: Building2 },
]
      ...
      <Card className="w-full max-w-lg border-gray-200 shadow-sm">
        <CardContent className="p-8">
          <div className="text-center">
            <h1 className="text-h3 font-bold text-gray-900">더명당 가입</h1>
