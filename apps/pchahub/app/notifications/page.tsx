...
import { Bell, Heart, MessageSquare, TrendingUp, Star, CheckCheck } from 'lucide-react'
import { Card, CardContent } from '@amakers/ui'

interface Notification {
  id: string
  type: 'inquiry-update' | 'brand-update' | 'community-reply' | 'new-listing' | 'system'
  title: string
  body: string
  href: string
  createdAt: string
...
const SEED_NOTIFICATIONS: Notification[] = [
  { id: 'n1', type: 'inquiry-update', title: '상담 신청 확인됨', body: '"호치킨 창업 상담" 신청이 접수되었습니다. 담당자가 1영업일 내 연락드립니다.', href: '/mypage', createdAt: '방금 전', read: false },
  { id: 'n2', type: 'brand-update', title: '관심 브랜드 업데이트', body: '저장하신 "텐퍼센트스페셜티커피" 브랜드가 창업비를 업데이트했습니다.', href: '/brands', createdAt: '3시간 전', read: false },
  { id: 'n3', type: 'community-reply', title: '커뮤니티 댓글', body: '내 질문 "치킨 프랜차이즈 가맹비 정말 의무인가요?"에 새 답글이 달렸습니다.', href: '/community', createdAt: '어제', read: false },
  { id: 'n4', type: 'new-listing', title: '관심 브랜드 매물', body: '저장하신 "데일리브루" 브랜드의 강남 직영 양도 매물이 등록되었습니다.', href: '/listings', createdAt: '2일 전', read: true },
  { id: 'n5', type: 'brand-update', title: '브랜드 정보 갱신', body: '공정거래위원회 최신 데이터가 반영되어 브랜드 정보가 업데이트되었습니다.', href: '/brands', createdAt: '3일 전', read: true },
  { id: 'n6', type: 'system', title: '브랜드 비교 기능 개선', body: '최대 4개 브랜드 동시 비교 기능이 개선되었습니다. 확인해보세요!', href: '/brands/compare', createdAt: '일주일 전', read: true },
  { id: 'n7', type: 'inquiry-update', title: '상담 진행 완료', body: '"육칠이 창업 상담"이 완료되었습니다. 리뷰를 남겨주세요.', href: '/mypage', createdAt: '2주 전', read: true },
]

const ICON_MAP = {
  'inquiry-update': MessageSquare,
  'brand-update': TrendingUp,
  'community-reply': MessageSquare,
  'new-listing': Star,
  'system': Bell,
}
...
const COLOR_MAP: Record<Notification['type'], string> = {
  ...
  'brand-update': 'text-emerald-600 bg-emerald-50',
  'community-reply': 'text-indigo-600 bg-indigo-50',
  'new-listing': 'text-amber-600 bg-amber-50',
  'system': 'text-gray-500 bg-gray-100',
}

const STORAGE_KEY = 'pchahub:notifications'
        ...
        <div className="container mx-auto py-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">상담·브랜드 업데이트·커뮤니티 알림을 확인하세요.</p>
            </div>
            {unreadCount > 0 && (
              <button
                onClick={markAllRead}
