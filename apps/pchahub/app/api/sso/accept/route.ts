// Consume an SSO passport from another amakers site and set our own
// NextAuth session cookie. Returns a redirect to ?next= (default /).
...
export async function GET(req: Request) {
  ...
  // Always return a redirect — never expose the token mechanism via JSON.
