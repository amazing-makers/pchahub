...
import { ArrowRight, Award, Star, Store } from 'lucide-react'
...
type Role = 'visitor' | 'owner' | 'industry'

const ROLES: Array<{ key: Role; label: string; helper: string; icon: typeof Star }> = [
  { key: 'visitor', label: '방문객·리뷰어', helper: '매장 방문·리뷰 작성', icon: Star },
  { key: 'owner', label: '매장 사장님', helper: '매장 등록·어워드 참가', icon: Store },
  { key: 'industry', label: '업계 관계자', helper: '어워드 심사·파트너', icon: Award },
]
      ...
      <Card className="w-full max-w-lg border-gray-200 shadow-sm">
        <CardContent className="p-8">
          <div className="text-center">
            <h1 className="text-h3 font-bold text-gray-900">베스트플레이스 가입</h1>
