...
import { ArrowLeft, ArrowRight, BookOpen, CheckCircle, Clock, Eye, Lock, ShoppingCart } from 'lucide-react'
...
export default function KnowhowDetailPage({ params }: KnowhowPageProps) {
  ...
  const breadcrumbs = buildBreadcrumbsJsonLd({
    items: [
      ...
      { name: item.title, url: `https://themanual.amakers.co.kr/knowhow/${item.id}` },
    ],
  })
      ...
      <section className="border-t border-gray-100 bg-gray-50">
        <div className="container mx-auto py-section">
          <div className="mx-auto max-w-xl text-center">
            ...
            <h2 className="mt-3 text-h4 font-bold text-gray-900">가맹 운영 노하우를 받아보세요</h2>
            <p className="mt-2 text-sm text-gray-500">실전 매뉴얼·원가 계산·마케팅 팁을 격주로 보내드립니다.</p>
            <NewsletterForm />
