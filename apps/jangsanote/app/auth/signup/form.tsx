...
import { ArrowRight, Search, TrendingUp, User } from 'lucide-react'
...
type Role = 'prospect' | 'franchisee' | 'industry'

const ROLES: Array<{ key: Role; label: string; helper: string; icon: typeof Search }> = [
  { key: 'prospect', label: '예비 창업자', helper: '정보 수집·커뮤니티 참여', icon: Search },
  { key: 'franchisee', label: '현직 점주', helper: '노하우 공유·모임 참가', icon: User },
  { key: 'industry', label: '업계 종사자', helper: '상권·트렌드 인텔 공유', icon: TrendingUp },
]
      ...
      <Card className="w-full max-w-lg border-gray-200 shadow-sm">
        <CardContent className="p-8">
          <div className="text-center">
            <h1 className="text-h3 font-bold text-gray-900">장사노트 가입</h1>
