...
const RAW_POSTS: RawPost[] = [
  ...
  {
    id: 'p16',
    title: '이자카야 창업 1년 — 직장인 상권 vs 관광 상권 차이',
    excerpt:
      '여의도 직장인 상권 vs 홍대 관광 상권. 같은 브랜드 이자카야인데 손익 구조가 완전히 달라요.',
    content: [
      '여의도에서 이자카야 가맹 1년차입니다. 개점 전 홍대 상권 매장과 많이 비교했는데, 실제로 운영해보니 손익 구조가 완전히 달랐습니다.',
      '여의도 직장인 상권: 점심 매출이 전체의 35%를 차지합니다. 저녁은 금요일 폭발적이고 월~목은 평탄합니다. 주말은 관광객이 없어서 매출이 평일 대비 60%에 불과합니다. 인테리어 유지비가 적고 단골 관리가 쉽습니다.',
      '홍대 관광 상권 (인근 점주에게 들은 이야기): 주말이 전체 매출의 45%를 차지하고, 월요일~화요일은 거의 비는 날이 있다고 합니다. 인건비가 일정하게 들지만 매출이 요일별로 들쑥날쑥해서 현금 흐름 관리가 어렵다고 합니다.',
      '어느 상권이 맞는지는 점주의 운영 스타일에 달렸습니다. 직장인 상권은 예측 가능한 매출, 관광 상권은 높은 천장이지만 변동이 큽니다.',
    ],
    authorId: 'u13',
    channelType: 'category',
    channelKey: 'japanese',
    category: 'experience',
    tags: ['이자카야', '일식', '상권분석', '여의도'],
    anonymous: false,
    pinned: false,
    hot: false,
    createdAt: '2026-04-22T19:12:00',
    views: 2140,
    likes: 88,
    commentCount: 2,
    comments: [
      C('u4', '직장인 상권은 점심 메뉴를 잘 운영하면 수익성이 올라가요. 점심 객수가 안정적이면 고정비 대비 효율이 높습니다.', '2026-04-22T20:24:00', 34),
      C('u9', '한식도 비슷한 패턴입니다. 직장인 상권은 점심 외엔 저녁 금요일만 보고 운영하는 구조가 됩니다.', '2026-04-22T21:38:00', 18),
    ],
  },
  {
    id: 'p17',
    title: '경기 신도시 음료 매장 — 여름 매출 2.4배',
    excerpt:
      '겨울에 월 900만원이던 음료 매장이 여름에 2,200만원까지 갔습니다. 여름 피크 관리 노하우.',
    content: [
      '경기 화성 동탄에서 과일주스 음료 매장을 1년 운영했습니다. 겨울 매출이 너무 낮아서 폐업 고민을 했는데, 여름에 2.4배까지 매출이 올라가서 버텼습니다.',
      '겨울(1~2월) 월 매출 900만원, 봄(3~5월) 1,400만원, 여름(6~8월) 2,200만원. 음료 카테고리는 계절 진폭이 이렇게 크다는 걸 창업 전엔 몰랐어요.',
      '여름 피크 관리 핵심: 1) 냉동 과일 재고를 4월부터 늘리기 시작. 6월에 재고 부족이 나면 손실. 2) 아르바이트 1명을 5월 말에 미리 채용해서 6월에 바로 투입. 3) 인기 메뉴 2가지를 여름 한정 패키지로 묶어서 객단가 +18%.',
      '겨울 저점을 버티는 게 관건입니다. 겨울 임대료 + 고정비를 최소화해두면 여름 매출로 연간 손익이 맞습니다.',
    ],
    authorId: 'u3',
    channelType: 'category',
    channelKey: 'beverage',
    ...
    pinned: false,
    hot: false,
    createdAt: '2026-04-21T14:28:00',
    views: 1620,
    likes: 72,
    commentCount: 1,
    comments: [
      C('u2', '음료 카테고리 계절 진폭 정말 큽니다. 카페도 여름에 음료 매출이 +50% 이상 오르는데, 단일 음료 매장은 더 극단적이겠네요. 겨울 생존 전략이 핵심이에요.', '2026-04-21T15:42:00', 28),
    ],
  },
  {
    id: 'p18',
    title: '경기 수원 매물 검토 중 — 지하 매장 권리금 합리적일까요',
    excerpt:
      '수원 팔달구 지하 1층 28평. 권리금 3,200만원, 보증금 5,000만원, 월세 280만원. 카페 창업 적합한지 의견 부탁드립니다.',
    content: [
      '경기 수원 팔달구에서 카페 창업 준비 중입니다. 지하 1층 28평 매물인데 권리금 3,200만원, 보증금 5,000만원, 월세 280만원 조건입니다.',
      '지하 매장이라 임대료가 1층 대비 30% 낮은 편인데, 대신 자연광이 없어서 인테리어 조명에 투자가 더 필요합니다. 수원 팔달구는 학원가와 주거 단지가 혼합된 상권입니다.',
      '카페로 지하 매장 운영해보신 분들 의견 부탁드립니다. 지하 매장의 실제 객수 유입이 1층 대비 얼마나 차이 나는지 궁금합니다.',
    ],
    authorId: 'u7',
    channelType: 'region',
    channelKey: 'gyeonggi',
    ...
    pinned: false,
    hot: false,
    createdAt: '2026-04-20T11:42:00',
    views: 1480,
    likes: 46,
    commentCount: 2,
    comments: [
      C('u2', '지하 매장은 SNS + 간판 시인성 보완이 핵심입니다. 입구에서 지하로 내려오게 만드는 유인이 있어야 하는데, 카페는 SNS 비주얼이 그 유인이 됩니다.', '2026-04-20T12:54:00', 32),
      C('u5', '수원 팔달구 지하 매장은 주거 단지 단골 위주라면 나쁘지 않습니다. 다만 신규 객수 유입은 1층 대비 -40% 정도 봐야 합니다.', '2026-04-20T14:18:00', 24),
    ],
  },
  {
    id: 'p19',
    title: '대구 동성로 장사 8년차 — 상권 변화 체감 후기',
    excerpt:
      '2016년 대비 2026년, 동성로 상권이 어떻게 달라졌는지 8년 운영자 시각으로 정리합니다.',
    content: [
      '대구 동성로에서 분식 매장 8년째 운영 중입니다. 2016년과 비교해 상권이 어떻게 달라졌는지 체감 후기 공유합니다.',
      '달라진 것: 1) 10~20대 객층 감소. 동성로 유동인구 자체가 줄었고, 젊은 층이 수성구·범어동·동구 방면으로 분산되었습니다. 2) 배달 비중 증가. 2016년엔 배달이 5% 미만이었는데 지금은 38%입니다. 3) 관광객(중국) 감소 후 아직 회복이 느립니다.',
      '안 달라진 것: 1) 점심 피크 시간대 직장인 객수는 여전히 안정적. 2) 동성로 핵심 코너 자리의 임대료 강세는 유지. 3) 10-20대 간식 수요는 줄었지만 배달로 전환되어 총 객수는 유지.',
      '대구 창업 고민하시는 분들 — 동성로보다 수성구·범어동 상권이 최근 성장세입니다. 입지 검토 시 참고하세요.',
    ],
    authorId: 'u12',
    channelType: 'region',
    channelKey: 'daegu',
    category: 'experience',
    tags: ['대구', '동성로', '상권변화', '8년차'],
    anonymous: false,
    pinned: false,
    hot: false,
    createdAt: '2026-04-19T10:08:00',
    views: 2380,
    likes: 106,
    commentCount: 1,
    comments: [
      C('u4', '지방 거점 도시 상권 변화가 비슷한 패턴이에요. 핵심 상권 유동인구 감소 + 배달 전환 + 외곽 신도시 이동. 대전·광주도 비슷합니다.', '2026-04-19T11:32:00', 42),
    ],
  },
  {
    id: 'p20',
    title: '대전 세종 상권 진입 — 공무원 객층 상권의 특이점',
    excerpt:
      '세종 정부세종청사 인근에서 한식 매장 운영 중. 공무원 객층 상권은 다른 상권과 어떻게 다른지.',
    content: [
      '세종 정부청사 인근에서 한식 도시락 매장을 운영한 지 2년이 됐습니다. 공무원 위주 상권은 일반 직장인 상권과 다른 특이점이 있습니다.',
      '특이점: 1) 점심 시간이 정확히 12:00 ~ 13:00에 집중. 일반 오피스 상권보다 점심 피크 폭이 훨씬 좁습니다. 60분 안에 모든 객수를 처리해야 합니다. 2) 금요일 저녁 매출이 미미. 공무원 문화상 회식이 적고, 연차를 쓰고 집에 일찍 가는 분위기. 3) 배달 비중이 낮습니다. 청사 구역 내 배달 허용이 제한적이에요.',
      '장점: 월~금 점심 객수가 기상청처럼 예측 가능합니다. 이상 기후 같은 외부 변수가 없어요. 일 객수 편차가 ±15% 이내로 작습니다.',
      '세종·대전 창업 고민하시는 분들 — 공무원 상권은 낮은 변동성이 장점이지만 저녁·주말 매출이 거의 없습니다. 점심 단일 매출로 임대료가 맞는지 꼭 계산해보세요.',
    ],
    authorId: 'u9',
    channelType: 'region',
    channelKey: 'daejeon',
    ...
    pinned: false,
    hot: false,
    createdAt: '2026-04-18T13:48:00',
    views: 1820,
    likes: 84,
    commentCount: 1,
    comments: [
      C('u5', '세종 상권 데이터 처음 봤습니다. 점심 집중 + 저녁 미미 패턴은 확실히 특이하네요. 점심 회전율 극대화 전략이 유일한 답이겠군요.', '2026-04-18T14:52:00', 32),
    ],
  },
  {
    id: 'p21',
    title: '가맹점 재계약 거부 당한 후기',
    excerpt:
      '5년 운영했는데 본사가 재계약을 거부했습니다. 사유 불명확 + 법적 대응 후기 공유합니다.',
    content: [
      '5년 운영한 카페 가맹점 재계약을 본사가 거부했습니다. 사유는 "매장 운영 기준 미달"이라고만 하고 구체적 내용을 안 알려줬어요.',
      '가맹사업법상 본사가 재계약을 거부하려면 명확한 계약 위반 사유를 서면으로 고지해야 합니다. 저는 서면 고지를 요구했고, 본사는 그제야 "위생 점검 3회 미통과"를 이유로 제시했습니다.',
      '저는 3회 위생 점검 결과를 모두 보관하고 있었는데, 실제로 2회만 지적 사항이 있었고 1회는 경미한 사항이었습니다. 변호사를 통해 사유 부적절 주장 → 본사가 재계약 조건 재협상으로 선회했습니다.',
      '재계약 거부 통보 받으면 당황하지 마시고: 1) 서면 사유 요구, 2) 본인 자료 전체 검토, 3) 가맹사업분쟁조정위원회 상담 순으로 진행하세요.',
    ],
    authorId: 'u6',
    channelType: 'general',
    channelKey: 'general',
    category: 'experience',
    tags: ['재계약', '본사갈등', '법적대응', '카페'],
    anonymous: false,
    pinned: false,
    hot: true,
    createdAt: '2026-04-17T17:22:00',
    views: 5820,
    likes: 264,
    commentCount: 2,
    comments: [
      C('u8', '재계약 거부 시 사유 서면 요구는 가맹사업법상 권리입니다. 서면 요구 후 14일 내에 서면 고지가 없으면 재계약 거부 자체가 무효가 됩니다.', '2026-04-17T18:34:00', 82),
      C('u4', '자료 보관이 정말 핵심입니다. 위생 점검, SV 방문, 본사 통보 — 모두 날짜와 내용을 기록해두세요.', '2026-04-17T19:48:00', 44),
    ],
  },
]
