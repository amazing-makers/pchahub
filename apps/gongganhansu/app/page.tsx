...
import { ArrowRight, Calculator, CheckCircle2, Clock, Eye, Search, Sparkles, Wrench } from 'lucide-react'
...
import { FEATURED_KNOWHOW } from '@/lib/knowhow-data'
  ...
  return (
    <main>
      ...
      <section className="container mx-auto pt-section">
        <div className="mb-6 flex items-end justify-between">
          <div>
            <h2 className="text-h3 font-semibold text-gray-900">전문가 노하우</h2>
            <p className="mt-1 text-sm text-gray-500">검증된 시공 전문가가 직접 작성한 F&B 인테리어 가이드</p>
          </div>
          <a
            href="/knowhow"
            className="inline-flex items-center gap-1 text-sm text-gray-600 hover:text-gray-900"
          >
            노하우 더 보기 <ArrowRight className="h-3.5 w-3.5" />
          </a>
        </div>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURED_KNOWHOW.map((article) => (
              ...
              <Card className="h-full overflow-hidden transition-shadow hover:shadow-md">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    <span className="text-xs font-semibold text-gray-700">{article.authorName}</span>
      ...
      <section className="border-y border-gray-100 bg-gray-50">
        <div className="container mx-auto py-section">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 text-h2 font-bold text-gray-900">시공 진행 방식</h2>
            <p className="mt-3 text-gray-600">견적 신청부터 완공·AS까지 4단계로 진행됩니다</p>
          </div>
