      ...
      <section className="border-b border-gray-200 bg-white">
        <div className="container mx-auto py-8">
          ...
          <nav className="mt-6 flex flex-wrap gap-2 text-sm">
            <a href="/services" className="rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-gray-700 hover:bg-gray-50">
              서비스
            </a>
            <a href="/portfolio" className="rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-gray-700 hover:bg-gray-50">
              사례
            </a>
            ...
            <a
              ...
              className="rounded-lg border border-[var(--brand-primary)]/30 bg-[var(--brand-primary)]/5 px-3 py-1.5 text-[var(--brand-primary)] hover:border-[var(--brand-primary)]/60"
            >
              캠페인 현황
            </a>
