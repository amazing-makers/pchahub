...
import { ArrowRight, Building2, Store, Users2 } from 'lucide-react'
...
type Role = 'franchisee' | 'hq' | 'partner'

const ROLES: Array<{ key: Role; label: string; helper: string; icon: typeof Store }> = [
  { key: 'franchisee', label: '점주', helper: '개점·판촉 캠페인 의뢰', icon: Store },
  { key: 'hq', label: '본사·가맹사업부', helper: '브랜드 캠페인 기획', icon: Building2 },
  { key: 'partner', label: '파트너사·대행사', helper: '협력 제안·공동 캠페인', icon: Users2 },
]
      ...
      <Card className="w-full max-w-lg border-gray-200 shadow-sm">
        <CardContent className="p-8">
          <div className="text-center">
            <h1 className="text-h3 font-bold text-gray-900">오픈런 가입</h1>
