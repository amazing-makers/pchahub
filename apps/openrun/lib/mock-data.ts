...
export const PROCESS_STEPS = [
  { step: 1, title: '상담 신청', desc: '의뢰 폼 작성 → 영업일 기준 24시간 이내 답변 + 초기 기획 방향 안내' },
  { step: 2, title: '기획안 확정', desc: '업종·예산·오픈 일정에 맞는 캠페인 플랜 설계 및 KPI 합의' },
  { step: 3, title: '셋업 & 론칭', desc: '오픈 D-7부터 SNS 콘텐츠·광고 세팅·인플루언서 매칭 동시 진행' },
  { step: 4, title: '운영 & 리포트', desc: '실시간 성과 모니터링 + 주간 수치 보고 + 월간 ROI 리포트 제공' },
]

export const FAQS: { q: string; a: string }[] = [
  { q: '캠페인 의뢰 후 언제부터 시작되나요?', a: '의뢰 후 영업일 기준 24시간 이내 담당자가 연락드립니다. 기획안 확정 후 오픈 D-7부터 셋업을 시작하므로, 오픈 2주 전 의뢰를 권장합니다.' },
  { q: '최소 예산은 얼마인가요?', a: '그랜드 오픈 캠페인 기준 150만 원부터 시작합니다. 업종·지역·캠페인 기간에 따라 달라지며, 상담 후 맞춤 견적을 무료로 제공해 드립니다.' },
  { q: '매출·노출 수 보장이 되나요?', a: '특정 수치를 보장드리기는 어렵지만 480건 누적 캠페인 데이터 기반 업종별 벤치마크 ROI를 제시하고, 달성 현황을 월간 리포트로 투명하게 공유합니다.' },
  { q: '어떤 채널에서 광고를 운영하나요?', a: '인스타그램·블로그·카카오 채널·네이버 광고·구글 디스플레이 등 업종별 효과가 검증된 채널을 조합해 운영합니다. 단일 채널 집중도 가능합니다.' },
  { q: '계약 기간은 어떻게 되나요?', a: '그랜드 오픈(1개월), 가맹 모집(3~6개월), 본사 성장(12개월) 세 가지 플랜이 있습니다. 단기 1회성 의뢰도 접수 가능합니다.' },
]
