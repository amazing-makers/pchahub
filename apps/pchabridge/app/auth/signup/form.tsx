...
import { ArrowRight, Rocket, TrendingUp, Users2 } from 'lucide-react'
...
type Role = 'investor' | 'founder' | 'advisor'

const ROLES: Array<{ key: Role; label: string; helper: string; icon: typeof TrendingUp }> = [
  { key: 'investor', label: '투자자·VC', helper: '딜 탐색·투자 검토', icon: TrendingUp },
  { key: 'founder', label: '창업가·대표', helper: 'IR 자료 등록·투자 유치', icon: Rocket },
  { key: 'advisor', label: '어드바이저·중개인', helper: '매칭 협력·네트워크', icon: Users2 },
]
      ...
      <Card className="w-full max-w-lg border-gray-200 shadow-sm">
        <CardContent className="p-8">
          <div className="text-center">
            <h1 className="text-h3 font-bold text-gray-900">피차브릿지 가입</h1>
